...
values ("muitieramá", "fgkjasdlkfja", "Vai tu muitieramá", "muitas", "substantivo", 1, 9, 1, 18);
...
insert into BuscaParagrafo(paragrafo, posicaoParagrafo)
values ("
...
nome.
",  1);
insert into BuscaLinha(linha, posicaoLinha)
values ("
Auto de moralidade composto por Gil Vicente por contemplação da
",  1);
...
insert into Livro(Nome, Resumo, Livro, Autor) values ("Ze", "asdfasdfa",
"
<p>
Auto de moralidade composto por Gil Vicente por contemplação da
sereníssima e muito católica rainha Lianor, nossa senhora, e representado por seu
